            ...
            <form className="w-full max-w-sm mx-auto bg-white p-8 rounded-md shadow-md">
                ...
                <div className="flex items-center justify-between my-5">
                    ...
                    <Link
                        ...
                        className="text-violet-500 text-sm font-medium text-primary-600 hover:underline dark:text-primary-500"
                    >
                        Forgot password?
                    </Link>
                </div>
                <button
                    className="w-full bg-violet-700 text-white text-sm font-bold py-3 px-4 rounded-md hover:bg-violet-700 transition duration-300"
                    type="button"
                    onClick={handleClick}
                >
                    Login
                ...
                <p className="my-3 text-sm font-light text-gray-500 dark:text-gray-400">
                    ...
                    <Link
                        href="/register"
                        className="text-violet-500 font-medium text-primary-600 hover:underline dark:text-primary-500"
                    >
                        Register
                    </Link>
                </p>
